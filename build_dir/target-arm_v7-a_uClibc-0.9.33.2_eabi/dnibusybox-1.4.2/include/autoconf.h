 ...
 */
#define AUTOCONF_TIMESTAMP "2016-03-14 03:08:00 PDT"
...
#define ENABLE_FEATURE_DNI_BAND_CHECK 1
#define USE_FEATURE_DNI_BAND_CHECK(...) __VA_ARGS__
#define SKIP_FEATURE_DNI_BAND_CHECK(...)
