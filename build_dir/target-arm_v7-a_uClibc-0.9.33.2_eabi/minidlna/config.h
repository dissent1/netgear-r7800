...
/* OS Version */
#define OS_VERSION "3.2.0-99-virtual"
...
/* Router's DLNA model name, such as "Windows Media Connect compatible
   (NETGEAR WNDR3800)" */
#define ROOTDEV_MODELNAME "Windows Media Connect compatible (NETGEAR R7800)"
