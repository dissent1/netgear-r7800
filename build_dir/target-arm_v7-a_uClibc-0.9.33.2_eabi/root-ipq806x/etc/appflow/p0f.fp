...
label = s:!:Vonage:VDV22
sys   = OpenBSD
sig   = 1:User-Agent=[VDV22],Host,Connection=[Keep-Alive]:Accept,Accept-Encoding,Accept-Language,Accept-Charset,Keep-Alive:VDV22

label = s:!:Vonage:VDV21
sys   = OpenBSD
sig   = 1:User-Agent=[VDV21],Host,Connection=[Keep-Alive]:Accept,Accept-Encoding,Accept-Language,Accept-Charset,Keep-Alive:VDV21
