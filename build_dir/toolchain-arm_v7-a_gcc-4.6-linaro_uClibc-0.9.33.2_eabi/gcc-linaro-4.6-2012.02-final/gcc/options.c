...
const struct cl_option cl_options[] =
{
  ...
  { "-fhuge-objects",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 13, 585,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fident",
  ...
  { "-fif-conversion",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 587,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fimplement-inlines",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 589,
    CL_CXX | CL_ObjCXX,
  ...
  { "-fimplicit-templates",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 592,
    CL_CXX | CL_ObjCXX,
  ...
  { "-finline-functions-called-once",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 29, 604,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fipa-cp-clone",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 614,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fipa-reference",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 619,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fkeep-inline-functions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 632,
    CL_COMMON | CL_REPORT,
  ...
  { "-flabels-ok",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 10, 634,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-flax-vector-conversions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 635,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
  ...
  { "-floop-block",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 637,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-floop-flatten",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 638,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-floop-optimize",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 14, 640,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  ...
  { "-flto-partition=balanced",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 646,
    CL_COMMON,
  ...
  { "-flto-partition=none",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 647,
    CL_COMMON,
  ...
  { "-fltrans-output-list=",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 651,
    CL_LTO | CL_JOINED,
  ...
  { "-fmath-errno",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 653,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fmem-report",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 659,
    CL_COMMON | CL_REPORT,
  ...
  { "-fmerge-constants",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 661,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fmodule-private",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 664,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fmodulo-sched",
  ...
  { "-fmove-loop-invariants",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 667,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fms-extensions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 668,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
  ...
  { "-fname-mangling-version-",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 23, 672,
  ...
  { "-fnew-abi",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 8, 673,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fnext-runtime",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 674,
    CL_ObjC | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fnil-receivers",
  ...
  { "-fnonansi-builtins",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 677,
    CL_CXX | CL_ObjCXX,
  ...
  { "-fnonnull-objects",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 16, 678,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fnothrow-opt",
  ...
  { "-fobjc-exceptions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 683,
    CL_ObjC | CL_ObjCXX,
  ...
  { "-fobjc-nilcheck",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 685,
    CL_ObjC | CL_ObjCXX,
  ...
  { "-fobjc-sjlj-exceptions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 686,
    CL_ObjC | CL_ObjCXX,
  ...
  { "-fomit-frame-pointer",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 688,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-foptimize-static-class-initialization",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 37, 693,
    CL_Java,
  ...
  { "-foptional-diags",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 15, 694,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-foutput-class-dir=",
    0,
  ...
  { "-fpack-struct",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 697,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fpeephole2",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 705,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fplan9-extensions",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 709,
    CL_C | CL_ObjC,
  ...
  { "-fpost-ipa-mem-report",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 712,
    CL_COMMON | CL_REPORT,
  ...
  { "-fpreprocessed",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 716,
    CL_C | CL_CXX | CL_Fortran | CL_ObjC | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fpretty-templates",
  ...
  { "-fprofile-generate",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 722,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fprofile-generate=",
  ...
  { "-freciprocal-math",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 732,
    CL_COMMON | CL_REPORT,
  ...
  { "-frecord-gcc-switches",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 733,
    CL_COMMON | CL_REPORT,
  ...
  { "-frecursive",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 736,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-freduced-reflection",
  ...
  { "-freorder-blocks-and-partition",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 29, 742,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-frepack-arrays",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 744,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  ...
  { "-frequire-return-statement",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 25, 747,
    CL_Go | CL_WARNING,
  ...
  { "-frerun-loop-opt",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 15, 749,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  ...
  { "-fresolution=",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 751,
    CL_LTO | CL_JOINED,
    -1, 0, CLVC_STRING, 0 },
  { "-frounding-math",
  ...
  { "-fsched-critical-path-heuristic",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 30, 755,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-dep-count-heuristic",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 756,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-interblock",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 758,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-pressure",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 760,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-spec",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 762,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-stalled-insns",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 766,
    CL_COMMON | CL_UINTEGER | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-stalled-insns-dep",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 767,
    CL_COMMON | CL_UINTEGER | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched2-use-traces",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 18, 772,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fschedule-insns",
  ...
  { "-fsecond-underscore",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 775,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fsection-anchors",
  ...
  { "-fsee",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 4, 777,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  ...
  { "-fsel-sched-pipelining-outer-loops",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 33, 779,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsel-sched-reschedule-pipelined",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 31, 780,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsigned-bitfields",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 789,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
  ...
  { "-fsigned-char",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 790,
  ...
  { "-fsigned-zeros",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 791,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsplit-ivs-in-unroller",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 795,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fstack-check",
    ...
    0,
    0,
    "specific", "no", OPT_fstack_check_, N_OPTS, 12, 799,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fstack-check=",
  ...
  { "-fstack-protector",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 804,
    CL_COMMON | CL_REPORT,
  ...
  { "-fstrength-reduce",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 16, 809,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fstrict-aliasing",
  ...
  { "-fstrict-enums",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 811,
    CL_CXX | CL_ObjCXX | CL_OPTIMIZATION,
  ...
  { "-fstrict-prototype",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 17, 813,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fstrict-volatile-bitfields",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 814,
    CL_COMMON | CL_REPORT,
  ...
  { "-ftarget-help",
    ...
    0,
    0,
    NULL, NULL, OPT__target_help, N_OPTS, 12, 817,
    CL_COMMON | CL_DRIVER,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ftarget=",
  ...
  { "-fthis-is-variable",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 17, 822,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fthread-jumps",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 823,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-bit-ccp",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 831,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-builtin-call-dce",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 832,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-copy-prop",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 835,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-copyrename",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 836,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-forwprop",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 841,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-distribute-patterns",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 30, 843,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-if-convert-stores",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 28, 846,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-im",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 847,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-linear",
    ...
    0,
    0,
    NULL, NULL, OPT_floop_interchange, N_OPTS, 17, 849,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ftree-loop-optimize",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 850,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-phiprop",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 853,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-salias",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 12, 857,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ftree-scev-cprop",
  ...
  { "-ftree-sink",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 859,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-store-ccp",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 15, 862,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ftree-store-copy-prop",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 21, 863,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  ...
  { "-ftree-vect-loop-version",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 866,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-funit-at-a-time",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 871,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-funsafe-math-optimizations",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 875,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-funsigned-bitfields",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 876,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
  ...
  { "-funwind-tables",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 879,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fuse-atomic-builtins",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 880,
    CL_Java,
  ...
  { "-fuse-boehm-gc",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 881,
    CL_Java,
  ...
  { "-fuse-cxa-get-exception-ptr",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 883,
    CL_CXX | CL_ObjCXX,
  ...
  { "-fuse-divide-subroutine",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 884,
    CL_Java,
  ...
  { "-fvar-tracking-assignments",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 25, 887,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fvar-tracking-assignments-toggle",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 32, 888,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fvar-tracking-uninit",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 889,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fvariable-expansion-in-unroller",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 31, 890,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fversion",
    ...
    0,
    0,
    NULL, NULL, OPT__version, N_OPTS, 8, 893,
    CL_COMMON | CL_DRIVER,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fvisibility-inlines-hidden",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 894,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  ...
  { "-fvtable-gc",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 10, 898,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fvtable-thunks",
    "No longer supported",
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 14, 899,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fweak",
  ...
  { "-fwhole-file",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 902,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fwhole-program",
  ...
  { "-fxref",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 5, 908,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fzee",
  ...
  { "-fzero-initialized-in-bss",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 910,
    CL_COMMON | CL_REPORT,
  ...
  { "-fzero-link",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 911,
    CL_ObjC | CL_ObjCXX,
  ...
  { "-gstabs+",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_gstabs, 7, 925,
    CL_COMMON | CL_JOINED | CL_MISSING_OK,
    -1, 0, CLVC_STRING, 0 },
  { "-gstrict-dwarf",
  ...
  { "-gxcoff+",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_gxcoff, 7, 914,
    CL_COMMON | CL_JOINED | CL_MISSING_OK,
    -1, 0, CLVC_STRING, 0 },
  { "-h",
    0,
  ...
  { "-munaligned-access",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 983,
    CL_TARGET | CL_REPORT,
  ...
  { "-mword-relocations",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 986,
    CL_TARGET | CL_REPORT,
  ...
  { "-pie",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 3, 1026,
    CL_COMMON | CL_REJECT_NEGATIVE,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-pipe",
    0,
  ...
  { "-shared",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 6, 1003,
    CL_COMMON | CL_REJECT_NEGATIVE,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-shared-libgcc",
    0,
